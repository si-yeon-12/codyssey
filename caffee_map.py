...
def load_analyze_csv():
    area_category = pd.read_csv("team_project/step1/area_category.csv")

    area_struct = pd.read_csv("team_project/step1/area_struct.csv")
    
    area_map = pd.read_csv("team_project/step1/area_map.csv")
    ...
    area_combined_one.to_csv('team_project/step1/area_combined_one.csv', index=None)
